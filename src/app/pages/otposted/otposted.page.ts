...
@Component({
  selector: 'app-otposted',
  templateUrl: './otposted.page.html',
  styleUrls: ['./otposted.page.scss'],
})
export class OtpostedPage implements OnInit {
  key:any;
  username:any;
  listsNote:any;
  data1:any;
  ...
  constructor(public toastCtrl: ToastController, public modalCtrl: ModalController, private noteService: NoteService, private nativeStorage: NativeStorage) {
    ...
    .then(
      ...
      res => {
        ...
        //profile
        this.noteService.overtimePosted(this.username).subscribe(
          data => {

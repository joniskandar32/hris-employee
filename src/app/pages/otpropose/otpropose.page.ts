...
@Component({
  selector: 'app-otpropose',
  templateUrl: './otpropose.page.html',
  styleUrls: ['./otpropose.page.scss'],
})
export class OtproposePage implements OnInit {
  key:any;
  username:any;
  listsNote:any;
  data1:any;
  ...
  constructor(public toastCtrl: ToastController, public modalCtrl: ModalController, private noteService: NoteService, private nativeStorage: NativeStorage) {
    ...
    .then(
      ...
      res => {
        ...
        //profile
        this.noteService.overtimePropose(this.username).subscribe(
          data => {

...
@Component({
  selector: 'app-claimpropose',
  templateUrl: './claimpropose.page.html',
  styleUrls: ['./claimpropose.page.scss'],
})
export class ClaimproposePage implements OnInit {
  key:any;
  username:any;
  listsNote:any;
  data1:any;
  ...
  constructor(public toastCtrl: ToastController, public modalCtrl: ModalController, private noteService: NoteService, private nativeStorage: NativeStorage) { 
    ...
    .then(
      ...
      res => {
        ...
        //profile
        this.noteService.claimsPropose(this.username).subscribe(
          data => {
